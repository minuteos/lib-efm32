...
EFM32_SDK_ORIGIN_EMDRV = $(EFM32_SDK_ORIGIN)platform/emdrv/
...
EFM32_SDK_EMDRV = $(OBJDIR)efm32-emdrv/
...
EFM32_MBEDTLS_INCLUDE = $(EFM32_SDK_MBEDTLS)include/ $(EFM32_SDK_MBEDTLS)sl_crypto/include/ $(EFM32_SDK_MBEDTLS)sl_crypto/src/cryptoacc/include/
...
efm32_sdk: $(EFM32_SDK_DEVICE) $(EFM32_SDK_CMSIS) $(EFM32_SDK_EMLIB) $(EFM32_SDK_EMDRV) $(EFM32_SDK_BOOT) $(EFM32_SDK_MBEDTLS)
...
$(EFM32_SDK_EMDRV): $(OBJDIR)
	@$(LN) -snf $(EFM32_SDK_ORIGIN_EMDRV) $(EFM32_SDK_EMDRV:/=)
