...
INCLUDE_DIRS += $(EFM32_DEVICE_INCLUDE) $(EFM32_CMSIS_INCLUDE) $(EFM32_EMLIB_INCLUDE) $(EFM32_BOOT_INCLUDE)
...
efm32_sdk: $(EFM32_SDK_DEVICE) $(EFM32_SDK_CMSIS) $(EFM32_SDK_EMLIB) $(EFM32_SDK_BOOT)
